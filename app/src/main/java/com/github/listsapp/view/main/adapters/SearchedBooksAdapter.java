...
public class SearchedBooksAdapter extends RecyclerView.Adapter<SearchedBooksAdapter.ViewHolder> {

    private GBookList gBookList;
    SearchedBooksAdapter.OnListItemClickListener listItemClickListener;
    private Context context;
    public SearchedBooksAdapter(Context context, SearchedBooksAdapter.OnListItemClickListener listItemClickListener)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SearchedBooksAdapter.ViewHolder(view);
    }
